import { getSQLStatements, getTablesWithSchema } from "./sql.js";
import { getMigrations } from "./migrations.js";
import { BaseCheckpointSaver, TASKS, WRITES_IDX_MAP, maxChannelVersion } from "@langchain/langgraph-checkpoint";
import pg from "pg";
//#region src/index.ts
...
* ```
*/
var PostgresSaver = class PostgresSaver extends BaseCheckpointSaver {
	pool;
	options;
	SQL_STATEMENTS;
	isSetup;
	...
	*/
	...
	async _migratePendingSends(pendingSends, mutableRow) {
		...
		row.checkpoint.channel_versions[TASKS] = Object.keys(mutableRow.checkpoint.channel_versions).length > 0 ? maxChannelVersion(...Object.values(mutableRow.checkpoint.channel_versions)) : this.getNextVersion(void 0);
	}
	/**
	...
	*/
	async putWrites(config, writes, taskId) {
		const query = writes.every((w) => w[0] in WRITES_IDX_MAP) ? this.SQL_STATEMENTS.UPSERT_CHECKPOINT_WRITES_SQL : this.SQL_STATEMENTS.INSERT_CHECKPOINT_WRITES_SQL;
